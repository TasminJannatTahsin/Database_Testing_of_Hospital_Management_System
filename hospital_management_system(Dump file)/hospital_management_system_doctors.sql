...
CREATE TABLE `doctors` (
  ...
  CONSTRAINT `fk_doctors_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `chk_doctors_fee` CHECK ((`consultation_fee` >= 0)),
  CONSTRAINT `chk_doctors_status` CHECK ((`status` in (_cp850'Active',_cp850'Inactive',_cp850'On Leave')))
